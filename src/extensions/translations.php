...
return [
  'en' => [
    ...
    'field.table.delete.confirm.all' => 'Do you really want to delete all entries?'
    ],
  'de' => [
    ...
    'field.table.delete.confirm.all' => 'Möchtest du wirklich alle Einträge löschen?'
  ],
  'fr' => [
    ...
    'field.table.delete.confirm.all' => 'Est-ce que tu veux vraiment supprimer toutes les entrées?'
  ]
];
